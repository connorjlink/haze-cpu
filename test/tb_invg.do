...
##              invg entity. It adds some useful signals for testing
...
add wave -noupdate -label CLK /tb_invg/CLK
add wave -noupdate -label reset /tb_invg/reset
...
add wave -noupdate -radix unsigned /tb_invg/s_iA
...
add wave -noupdate -radix unsigned /tb_invg/s_oF
...
#add wave -noupdate -divider {Standard Inputs}
#add wave -noupdate /tb_invg/CLK
#add wave -noupdate /tb_invg/reset
...
#add wave -noupdate /tb_invg/DUT0/g_Weight/iLd
#add wave -noupdate /tb_invg/DUT0/g_Weight/sQ
#add wave -noupdate /tb_invg/DUT0/g_Weight/oQ

# The following command will add all of the signals within the DUT0 module's scope (but not internal
# signals to submodules). 
#add wave -noupdate /tb_invg/DUT0/*
