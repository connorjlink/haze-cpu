...
##              ip entity. It adds some useful signals for testing
...
add wave -noupdate -label CLK /tb_ip/CLK
add wave -noupdate -label reset /tb_ip/reset
...
add wave -noupdate -radix unsigned /tb_ip/s_iLoad
add wave -noupdate -radix hexadecimal /tb_ip/s_iAddr
add wave -noupdate -radix hexadecimal /tb_ip/s_inInc2_Inc4
add wave -noupdate -radix hexadecimal /tb_ip/s_iStall
...
#add wave -noupdate -divider {Standard Inputs}
#add wave -noupdate /tb_ip/CLK
#add wave -noupdate /tb_ip/reset
...
#add wave -noupdate /tb_ip/DUT0/g_Weight/iLd
#add wave -noupdate /tb_ip/DUT0/g_Weight/sQ
#add wave -noupdate /tb_ip/DUT0/g_Weight/oQ

# The following command will add all of the signals within the DUT0 module's scope (but not internal
# signals to submodules).
#add wave -noupdate /tb_ip/DUT0/*
