...
##              adder_N entity. It adds some useful signals for testing
...
add wave -noupdate -label CLK /tb_adder_N/CLK
add wave -noupdate -label reset /tb_adder_N/reset
...
add wave -noupdate -radix unsigned /tb_adder_N/s_iA
add wave -noupdate -radix unsigned /tb_adder_N/s_iB
add wave -noupdate -radix unsigned /tb_adder_N/s_iCi
...
add wave -noupdate -radix unsigned /tb_adder_N/s_oS
add wave -noupdate -radix unsigned /tb_adder_N/s_oCo
...
#add wave -noupdate -divider {Standard Inputs}
#add wave -noupdate /tb_adder_N/CLK
#add wave -noupdate /tb_adder_N/reset
