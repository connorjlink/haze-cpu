...
##              decoder entity. It adds some useful signals for testing
...
add wave -noupdate -label CLK /tb_decoder/CLK
add wave -noupdate -label reset /tb_decoder/reset
...
add wave -noupdate -radix hexadecimal /tb_decoder/s_iInsn
...
add wave -noupdate -radix binary /tb_decoder/s_oOpcode
add wave -noupdate -radix unsigned /tb_decoder/s_oRD
add wave -noupdate -radix unsigned /tb_decoder/s_oRS1
add wave -noupdate -radix unsigned /tb_decoder/s_oRS2
add wave -noupdate -radix binary /tb_decoder/s_oFunc3
add wave -noupdate -radix binary /tb_decoder/s_oFunc7
add wave -noupdate -radix signed /tb_decoder/s_oiImm
add wave -noupdate -radix signed /tb_decoder/s_osImm
add wave -noupdate -radix signed /tb_decoder/s_obImm
add wave -noupdate -radix signed /tb_decoder/s_ouImm
add wave -noupdate -radix signed /tb_decoder/s_ojImm
...
#add wave -noupdate -divider {Standard Inputs}
#add wave -noupdate /tb_decoder/CLK
#add wave -noupdate /tb_decoder/reset
...
#add wave -noupdate /tb_decoder/DUT0/g_Weight/iLd
#add wave -noupdate /tb_decoder/DUT0/g_Weight/sQ
#add wave -noupdate /tb_decoder/DUT0/g_Weight/oQ
