...
##              barrel_shifter entity. It adds some useful signals for testing
...
vcom -2008 -work work ../src/mux2t1.vhd
vcom -2008 -work work ../src/barrel_shifter.vhd
vcom -2008 -work work ../test/tb_barrel_shifter.vhd

quit -sim
vsim -voptargs=+acc tb_barrel_shifter
...
add wave -noupdate -label CLK /tb_barrel_shifter/CLK
add wave -noupdate -label reset /tb_barrel_shifter/reset
...
add wave -noupdate -radix hexadecimal /tb_barrel_shifter/s_iA
add wave -noupdate -radix hexadecimal /tb_barrel_shifter/s_iB
add wave -noupdate -radix hexadecimal /tb_barrel_shifter/s_iNLogical_Arithmetic
add wave -noupdate -radix hexadecimal /tb_barrel_shifter/s_iNLeft_Right
...
add wave -noupdate -radix hexadecimal /tb_barrel_shifter/s_oF
...
add wave -noupdate -divider {Standard Intermediates}
add wave -noupdate -radix hexadecimal sim:/tb_barrel_shifter/DUT0/*
...
#add wave -noupdate /tb_adder_N/DUT0/g_Weight/iLd
#add wave -noupdate /tb_adder_N/DUT0/g_Weight/sQ
#add wave -noupdate /tb_adder_N/DUT0/g_Weight/oQ

# The following command will add all of the signals within the DUT0 module's scope (but not internal
# signals to submodules).
#add wave -noupdate /tb_adder_N/DUT0/*
