...
##              alu entity. It adds some useful signals for testing
...
add wave -noupdate -label CLK /tb_alu/CLK
add wave -noupdate -label reset /tb_alu/reset
...
add wave -noupdate -radix hexadecimal /tb_alu/s_iA
add wave -noupdate -radix hexadecimal /tb_alu/s_iB
add wave -noupdate -radix unsigned /tb_alu/s_iALUOp
...
add wave -noupdate -radix hexadecimal /tb_alu/s_oF
add wave -noupdate -radix binary /tb_alu/s_oCo
...
#add wave -noupdate /tb_alu/DUT0/g_Weight/iLd
#add wave -noupdate /tb_alu/DUT0/g_Weight/sQ
#add wave -noupdate /tb_alu/DUT0/g_Weight/oQ

# The following command will add all of the signals within the DUT0 module's scope (but not internal
# signals to submodules).
#add wave -noupdate /tb_alu/DUT0/*
