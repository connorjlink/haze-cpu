...
##              adder entity. It adds some useful signals for testing
...
add wave -noupdate -label CLK /tb_adder/CLK
add wave -noupdate -label reset /tb_adder/reset
...
add wave -noupdate -radix unsigned /tb_adder/s_iA
add wave -noupdate -radix unsigned /tb_adder/s_iB
add wave -noupdate -radix unsigned /tb_adder/s_iCi
...
add wave -noupdate -radix unsigned /tb_adder/s_oS
add wave -noupdate -radix unsigned /tb_adder/s_oCo
...
#add wave -noupdate /tb_adder/reset
...
#add wave -noupdate /tb_adder/DUT0/g_Weight/iLd
#add wave -noupdate /tb_adder/DUT0/g_Weight/sQ
#add wave -noupdate /tb_adder/DUT0/g_Weight/oQ
