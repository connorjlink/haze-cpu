...
##              register_N entity. It adds some useful signals for testing
...
add wave -noupdate -label CLK /tb_register_N/CLK
add wave -noupdate -label reset /tb_register_N/reset
...
add wave -noupdate -radix unsigned /tb_register_N/s_iWE
add wave -noupdate -radix unsigned /tb_register_N/s_iD
...
add wave -noupdate -radix unsigned /tb_register_N/s_oQ
...
#add wave -noupdate -divider {Standard Inputs}
#add wave -noupdate /tb_register_N/CLK
#add wave -noupdate /tb_register_N/reset
...
#add wave -noupdate /tb_register_N/DUT0/g_Weight/iLd
#add wave -noupdate /tb_register_N/DUT0/g_Weight/sQ
#add wave -noupdate /tb_register_N/DUT0/g_Weight/oQ

# The following command will add all of the signals within the DUT0 module's scope (but not internal
# signals to submodules).
#add wave -noupdate /tb_register_N/DUT0/*
