...
##              alu_addsub entity. It adds some useful signals for testing
...
add wave -noupdate -label CLK /tb_alu_addsub/CLK
add wave -noupdate -label reset /tb_alu_addsub/reset
...
add wave -noupdate -radix unsigned /tb_alu_addsub/s_iA
add wave -noupdate -radix unsigned /tb_alu_addsub/s_iB
add wave -noupdate -radix unsigned /tb_alu_addsub/s_iImm
add wave -noupdate -radix unsigned /tb_alu_addsub/s_iALUSrc
add wave -noupdate -radix unsigned /tb_alu_addsub/s_inAdd_Sub
...
add wave -noupdate -radix unsigned /tb_alu_addsub/s_oS
add wave -noupdate -radix unsigned /tb_alu_addsub/s_oCo
...
#add wave -noupdate -divider {Standard Inputs}
#add wave -noupdate /tb_alu_addsub/CLK
#add wave -noupdate /tb_alu_addsub/reset
...
#add wave -noupdate /tb_alu_addsub/DUT0/g_Weight/iLd
#add wave -noupdate /tb_alu_addsub/DUT0/g_Weight/sQ
#add wave -noupdate /tb_alu_addsub/DUT0/g_Weight/oQ

# The following command will add all of the signals within the DUT0 module's scope (but not internal
# signals to submodules).
#add wave -noupdate /tb_alu_addsub/DUT0/*
