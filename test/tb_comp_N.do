...
##              comp_N entity. It adds some useful signals for testing
...
add wave -noupdate -label CLK sim:/tb_comp_N/CLK
add wave -noupdate -label reset sim:/tb_comp_N/reset
...
add wave -noupdate -radix hexadecimal /tb_comp_N/s_iA
...
add wave -noupdate -radix hexadecimal /tb_comp_N/s_oF
...
#add wave -noupdate -divider {Standard Inputs}
#add wave -noupdate /tb_comp_N/CLK
#add wave -noupdate /tb_comp_N/reset
...
#add wave -noupdate /tb_comp_N/DUT0/g_Weight/iLd
#add wave -noupdate /tb_comp_N/DUT0/g_Weight/sQ
#add wave -noupdate /tb_comp_N/DUT0/g_Weight/oQ

# The following command will add all of the signals within the DUT0 module's scope (but not internal
# signals to submodules).
#add wave -noupdate /tb_comp_N/DUT0/*
