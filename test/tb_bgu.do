...
##              bgu entity. It adds some useful signals for testing
...
add wave -noupdate -label CLK /tb_bgu/CLK
add wave -noupdate -label reset /tb_bgu/reset
...
add wave -noupdate -radix hexadecimal /tb_bgu/s_iDS1
add wave -noupdate -radix hexadecimal /tb_bgu/s_iDS2
add wave -noupdate -radix hexadecimal /tb_bgu/s_iBGUOp
...
add wave -noupdate -radix binary /tb_bgu/s_oBranch
...
#add wave -noupdate -divider {Standard Inputs}
#add wave -noupdate /tb_bgu/CLK
#add wave -noupdate /tb_bgu/reset
...
#add wave -noupdate /tb_bgu/DUT0/g_Weight/iLd
#add wave -noupdate /tb_bgu/DUT0/g_Weight/sQ
#add wave -noupdate /tb_bgu/DUT0/g_Weight/oQ

# The following command will add all of the signals within the DUT0 module's scope (but not internal
# signals to submodules).
#add wave -noupdate /tb_bgu/DUT0/*
