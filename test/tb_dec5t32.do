...
##              dec5t32 entity. It adds some useful signals for testing
...
add wave -noupdate -label CLK /tb_dec5t32/CLK
add wave -noupdate -label reset /tb_dec5t32/reset
...
add wave -noupdate -radix unsigned /tb_dec5t32/s_iS
...
add wave -noupdate -radix unsigned /tb_dec5t32/s_oQ
...
#add wave -noupdate -divider {Standard Inputs}
#add wave -noupdate /tb_dec5t32/CLK
#add wave -noupdate /tb_dec5t32/reset
...
#add wave -noupdate /tb_dec5t32/DUT0/g_Weight/iLd
#add wave -noupdate /tb_dec5t32/DUT0/g_Weight/sQ
#add wave -noupdate /tb_dec5t32/DUT0/g_Weight/oQ

# The following command will add all of the signals within the DUT0 module's scope (but not internal
# signals to submodules).
#add wave -noupdate /tb_dec5t32/DUT0/*
