...
##              addsub_N entity. It adds some useful signals for testing
...
add wave -noupdate -radix unsigned /tb_addsub_N/s_iA
add wave -noupdate -radix unsigned /tb_addsub_N/s_iB
add wave -noupdate -radix unsigned /tb_addsub_N/s_inAdd_Sub
...
add wave -noupdate -radix unsigned /tb_addsub_N/s_oS
add wave -noupdate -radix unsigned /tb_addsub_N/s_oCo
...
#add wave -noupdate -divider {Standard Inputs}
#add wave -noupdate /tb_addsub_N/CLK
#add wave -noupdate /tb_addsub_N/reset
...
#add wave -noupdate /tb_addsub_N/DUT0/g_Weight/iLd
#add wave -noupdate /tb_addsub_N/DUT0/g_Weight/sQ
#add wave -noupdate /tb_addsub_N/DUT0/g_Weight/oQ

# The following command will add all of the signals within the DUT0 module's scope (but not internal
# signals to submodules).
#add wave -noupdate /tb_addsub_N/DUT0/*
