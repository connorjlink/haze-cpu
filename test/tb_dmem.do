...
##              mem entity. It adds some useful signals for testing
...
add wave -noupdate -label CLK /tb_dmem/CLK
add wave -noupdate -label reset /tb_dmem/reset
...
add wave -noupdate -radix hexadecimal /tb_dmem/s_iD
add wave -noupdate -radix hexadecimal /tb_dmem/s_iA
add wave -noupdate -radix hexadecimal /tb_dmem/s_iWE
...
add wave -noupdate -radix hexadecimal /tb_dmem/s_oQ
...
#add wave -noupdate -divider {Standard Inputs}
#add wave -noupdate /tb_dmem/CLK
#add wave -noupdate /tb_dmem/reset
...
#add wave -noupdate /tb_dmem/DUT0/g_Weight/iLd
#add wave -noupdate /tb_dmem/DUT0/g_Weight/sQ
#add wave -noupdate /tb_dmem/DUT0/g_Weight/oQ

# The following command will add all of the signals within the DUT0 module's scope (but not internal
# signals to submodules).
#add wave -noupdate /tb_dmem/DUT0/*
